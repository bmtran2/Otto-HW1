...
public class Controller implements Initializable
{
    ...
    private void deleteEmployee(ActionEvent actionEvent) {
        int selectedEmployee = employeeListView.getSelectionModel().getSelectedIndex();
        ...
        if (selectedEmployee >= 0) {
            ...
            alert.setHeaderText("No employee was chosen.");
            alert.setContentText("Please choose an employee in the list.");
            alert.show();
        }
    }
